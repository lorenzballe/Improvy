                  ...
                  Container(
                    ...
                    child: Row(mainAxisSize: MainAxisSize.min, children: [
                      Text('LEVEL ${animalLevel.level}',
                        style: TextStyle(fontSize: 10, fontWeight: FontWeight.w900, color: Colors.white.withAlpha(128), letterSpacing: 4, decoration: TextDecoration.none)),
                      const SizedBox(width: 14),
                      AnimalIcon(name: animalLevel.name, color: animalLevel.color, size: 20),
                      const SizedBox(width: 6),
                      Text(animalLevel.name.toUpperCase(),
                        style: TextStyle(fontSize: 10, fontWeight: FontWeight.w900, color: animalLevel.color, letterSpacing: 2, decoration: TextDecoration.none)),
                    ]),
                  ),
